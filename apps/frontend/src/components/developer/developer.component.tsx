      ...
      <div className="flex flex-col gap-[40px]">
        <div className="text-[14px] text-textColor leading-[1.7]">
          {t(
            ...
            'Create an OAuth App to let other Postaryx users authorize your product to post on their behalf.'
          )}
          <br />
          {t(
        ...
        <div className="bg-newBgColorInner rounded-[12px] border border-newBorder overflow-hidden">
          <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
            <div>
              ...
              <div className="text-[14px] text-textItemBlur mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with Postaryx on behalf of your users.'
                )}
              </div>
            </div>
            <div className="flex gap-[6px] shrink-0 pt-[2px]">
              <a
                ...
                href="https://postaryx.com/docs/public-api/oauth"
                target="_blank"
              >
          ...
          <div className="p-[20px]">
            <button
              ...
              className="cursor-pointer px-[20px] h-[44px] bg-btnPrimary hover:opacity-95 transition-colors text-white rounded-[10px] text-[14px] font-[600]"
            >
        ...
        <div className="bg-newBgColorInner rounded-[12px] border border-newBorder overflow-hidden">
          ...
          <div className="p-[20px] flex flex-col gap-[16px]">
            <div className="flex flex-col gap-[6px]">
              <label className="text-[14px] font-[600] text-textItemBlur">
                {t('app_name', 'App Name')} *
              </label>
              <input
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <div className="flex items-center gap-[12px]">
                ...
                <button
                  type="button"
                  onClick={openMedia}
                  className="cursor-pointer px-[16px] h-[36px] bg-btnSimple hover:bg-boxHover transition-colors rounded-[10px] text-[14px] font-[600]"
                >
            ...
            <div className="flex gap-[8px]">
              ...
              <button
                ...
                className="cursor-pointer px-[20px] h-[44px] bg-btnSimple hover:bg-boxHover transition-colors rounded-[10px] text-[14px] font-[600]"
              >
                {t('cancel', 'Cancel')}
              </button>
            </div>
        ...
        {editing ? (
          ...
          <div className="p-[20px] flex flex-col gap-[16px]">
            <div className="flex items-center gap-[12px]">
              ...
              <div>
                <div className="text-[16px] font-[600]">{app.name}</div>
                {app.description && (
        ...
        <div className="p-[20px] flex flex-col gap-[16px]">
          <div className="flex flex-col gap-[6px]">
            ...
            <div className="bg-newBgColorInner border border-newBorder rounded-[8px] px-[16px] h-[44px] flex items-center overflow-hidden">
              <code className="font-mono text-[14px] flex-1 truncate">{app.clientId}</code>
            </div>
          </div>
          <div className="flex flex-col gap-[6px]">
            <div className="text-[14px] font-[600] text-textItemBlur">
            ...
            <div className="bg-newBgColorInner border border-newBorder rounded-[8px] px-[16px] h-[44px] flex items-center overflow-hidden">
              {plaintextSecret ? (
                ...
                <span className="text-textItemBlur text-[14px]">
                  {t(
          ...
          <div className="flex gap-[8px]">
            ...
            <button
              type="button"
              onClick={deleteApp}
              className="cursor-pointer px-[16px] h-[36px] bg-red-600 hover:bg-red-700 text-white transition-colors rounded-[10px] text-[14px] font-[600] flex items-center gap-[6px]"
            >
