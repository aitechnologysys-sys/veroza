...
export const ManageModal: FC<AddEditModalProps> = (props) => {
  ...
  return (
    <div className="w-full h-full flex-1 p-[40px] flex relative">
      <div className="flex flex-1 bg-newBgColorInner border border-newBorder shadow-menu rounded-[20px] flex-col overflow-hidden">
        <div className="flex-1 flex">
          <div className="flex flex-col flex-1 border-e border-newBorder">
            <div className="bg-newSettings h-[64px] border-b border-newBorder flex items-center gap-[12px] px-[20px] ds-h1 text-[19px]">
          ...
          <div className="w-[580px] flex flex-col">
            <div className="bg-newSettings h-[64px] border-b border-newBorder flex items-center gap-[12px] px-[20px] ds-h1 text-[19px]">
              ...
              <div className="cursor-pointer">
                <CloseIcon onClick={askClose} className="text-pxMuted" />
              </div>
            </div>
        ...
        <div className="select-none h-[84px] py-[20px] border-t border-newBorder flex items-center">
          ...
          <div className="pe-[20px] flex items-center justify-end gap-[8px]">
            {existingData?.integration && (
              <button
                onClick={deletePost}
                className="cursor-pointer flex text-pxDanger gap-[8px] items-center text-[15px] font-[600]"
              >
                <div>
                  <TrashIcon />
                </div>
            ...
            {!addEditSets && (
              <button
                ...
                className="relative cursor-pointer disabled:cursor-not-allowed px-[20px] h-[44px] bg-btnSimple border border-newBorder justify-center items-center flex rounded-[10px] text-[14px] font-[600] transition-colors hover:bg-boxHover"
              >
                {loading && (
            ...
            {addEditSets && (
              <button
                className="text-white text-[15px] font-[600] min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[10px] bg-btnPrimary ps-[20px] pe-[16px] transition-opacity hover:opacity-90"
                disabled={
                  selectedIntegrations.length === 0 || loading || locked
                }
                onClick={schedule('draft')}
            ...
            {!addEditSets && (
              <div className="group cursor-pointer relative">
                <button
                  ...
                  className="text-white relative min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[10px] bg-btnPrimary ps-[20px] pe-[16px] transition-opacity hover:opacity-90"
                >
                  {loading && (
                    <div className="absolute left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%]">
                ...
                {!dummy && (
                  <button
                    ...
                    className="rounded-[12px] border border-newBorder shadow-menu z-[300] disabled:cursor-not-allowed disabled:opacity-80 hidden group-hover:flex absolute bottom-[100%] -left-[12px] p-[12px] w-[206px] bg-newBgColorInner"
                  >
                    <div className="text-white rounded-[10px] bg-btnPrimary h-[44px] w-full flex justify-center items-center post-now transition-opacity hover:opacity-90">
                      {t('post_now', 'Post Now')}
                    </div>
                  </button>
                )}
